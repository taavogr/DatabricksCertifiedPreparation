...
----- solo puede sobreescirbir los nuevos registros que coincidan con el esquema actual de la tabla
...
---- para evitar duplicidad al insertar usamos la sentencia merges
