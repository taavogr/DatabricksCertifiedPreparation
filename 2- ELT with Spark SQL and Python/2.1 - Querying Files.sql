...
--si todos los archivos son la misma extension, poner solo el path
...
-- COMMAND ----------
 ...
 -- input file name nos podria ver para ver en que arhcivo esta errado la data
 SELECT *,
...
-- lee los datos pero no estan bien analizados
SELECT * FROM csv.`${dataset.bookstore}/books-csv`

-- COMMAND ----------

--creamos una tabla, pero lamentablemnte no sera delta
