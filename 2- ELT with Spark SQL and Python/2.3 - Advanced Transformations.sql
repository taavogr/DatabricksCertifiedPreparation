...
----  existe una extructura para recorrer datos anidados
...
---- pasamos el campo anidado a uno estructurado creando una vista temporal
...
---- ahora podemos navegar sobre la estructura
...
---- aplano la matrix para quitar duplicidad o repetidos en los arreglos  en book_id con flatten
SELECT customer_id,
...
---- EL COMANDO INTERSECT SOLO DEVUELVE LAS COINCIDENCIA DE FILAS
SELECT * FROM orders 
INTERSECT 
SELECT * FROM orders_updates 
...
---- MINUS SOLO OBTIENE LOS DATOS QUE NO CRUZAND DE LA PRIMERA TABLA
SELECT * FROM orders 
MINUS 
SELECT * FROM orders_updates 
...
---- PIVOT SE USA PARA CAMBIAR LA PERSPECTIVA DE LOS DATOS
